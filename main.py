...
def start(message):
    ...
    if message.text == '/start':
        str1 = "Вы выбираете один из двух вариантов действий - играть как chicken (стратегия труса) или как hawk (стратегия храбреца). Ниже вы можете ознакомиться с матрицей выигрышей за 1 взаимодействие(выигрыши в хсе). Далее происходит взаимодействие каждого игрока с каждым, и выигрыши суммируются по всем взаимодействиям. Итоговая сумма и есть конечный выигрыш каждого игрока. Выигрыши: \nс-с: 1-1\nс-h: ⅕-2\nh-c: 2-⅕\nh-h: 0-0"
